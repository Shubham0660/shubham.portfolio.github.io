...
(window.PROJECTS = window.PROJECTS || []).push({
  ...
  action: "RICE-prioritised the fix, then shipped a personalised partner page for every MFD: custom name, logo, tagline, AMFI number and product offerings, plus vernacular support and a built-in lead tracking and reminder system, so each partner has a credible identity that eases investor conversion.",
  ...
  northCard: {
    value: "4,000+",
    name: "client activations in 7 days",
    desc: "A credible page did what months of manual trust-building couldn't. 9,000+ leads generated in one quarter."
  },
