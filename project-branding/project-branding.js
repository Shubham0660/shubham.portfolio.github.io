...
(window.PROJECTS = window.PROJECTS || []).push({
  ...
  steps: [
    ...
    },
    {
      ...
      body: "Scored every initiative on RICE to separate genuine trust blockers from nice to have engagement features. Advisor credentials scored highest at 198, confirming that identity, not engagement tooling, was the real gate on conversion. Vernacular support carried equal impact but heavier effort, so it was sequenced rather than dropped.",
