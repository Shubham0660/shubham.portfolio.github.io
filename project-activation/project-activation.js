...
(window.PROJECTS = window.PROJECTS || []).push({
  ...
  problem: "Acquisition was no longer the constraint. Partners were joining faster than ever, but only 55% completed a first transaction within 45 days of empanelment.",
  frameQ: "Why does acquisition scale but activation stay flat?",
  scope: "Solution scope: activation was breaking across organisational handoffs, not inside a single product flow.",

  finCriticality: {
    value: "~45%",
    desc: "of newly acquired partners never generated business in the activation window, delaying CAC recovery and stretching payback on every marketing rupee."
  },

  task: "Owned it end to end. Treated activation as a funnel optimisation problem, not a product one: cohort analysis in SQL, behavioural events in Mixpanel, 80+ partner interviews, then orchestrated delivery across Product, Marketing, Sales, Ops and Enablement.",

  action: "Segmented one funnel into two. Built a training ecosystem for Non-ARN partners blocked on certification, and a client acquisition stack for ARN partners blocked on finding customers, then rebuilt reporting, ownership and incentives around each.",

  northCard: {
    value: "55% → 75%",
    name: "first transaction within D45",
    desc: "Moving activation from 55% to 75% recovers 2 more active partners per 100 leads, compounding hard at scale."
  },
